...
define('DB_USER', 'ender');  //数据库用户名
define('DB_PWD', 'Feng,HK,4778!');//数据库密码
define('DB_NAME', 'GFW-Breaker');  //数据库名称
